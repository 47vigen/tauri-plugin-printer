...
const encodeBase64 = (str) => typeof btoa === "function" ? btoa(str) : Buffer.from(str).toString("base64");
...
export { getJob, getJobs, getPrinters, pauseJob, printFile, removeJob, restartJob, resumeJob };
